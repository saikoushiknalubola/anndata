...
const GovernmentBranding: React.FC = () => {
  ...
  return (
    <div className="w-full bg-gradient-to-r from-white to-cream/30 border-b border-leaf/30 py-2 px-4 flex items-center justify-between overflow-hidden shadow-sm">
